...
process_video("inputs/model.mov",output_json_phone="phone_landmarks.json", output_json_real="pose_landmarks.json")

# Load the data
input_file = 'phone_landmarks.json'
output_file = 'midpoints.json'
